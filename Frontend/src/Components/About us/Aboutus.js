    ...
    <>
      <div className="about-page-section">
        <div className="about-page-container">
          <div className="aboutUs-head" role="alert">
            <h1>About Us <i class="fa-solid fa-wheat"></i><i class="fa-solid fa-leaf"></i></h1>
          </div>
          <div className="about-content-section">
            <div className="about-main-img">
              <svg id="animation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 302.7 436.37">
                <defs>
                  ...
                  <linearGradient id="Dégradé_sans_nom_4-2" x1="196.6" y1="195.74" x2="177" y2="178.38" href="#Dégradé_sans_nom_4"></linearGradient>
                  <linearGradient id="Dégradé_sans_nom_3-2" x1="296.11" y1="44.64" x2="176.48" y2="155.68" href="#Dégradé_sans_nom_3"></linearGradient>
                  <linearGradient id="Dégradé_sans_nom_2-2" x1="274.3" y1="150.3" x2="231.97" y2="99.99" href="#Dégradé_sans_nom_2"></linearGradient>
                  <linearGradient id="Dégradé_sans_nom_4-3" x1="-19.56" y1="223.16" x2="218.1" y2="279.92" href="#Dégradé_sans_nom_4"></linearGradient>
                  <linearGradient id="Dégradé_sans_nom_2-3" x1="16.11" y1="204.08" x2="92.18" y2="276.48" href="#Dégradé_sans_nom_2"></linearGradient>
                  <linearGradient id="Dégradé_sans_nom_2-4" x1="106.7" y1="255.03" x2="106.7" y2="255.03" href="#Dégradé_sans_nom_2"></linearGradient>
                  <linearGradient id="Dégradé_sans_nom_3-3" x1="63.36" y1="209.36" x2="54.16" y2="240.65" href="#Dégradé_sans_nom_3"></linearGradient>
                  <linearGradient id="Dégradé_sans_nom_4-4" x1="75.32" y1="182.31" x2="144.32" y2="160.33" href="#Dégradé_sans_nom_4"></linearGradient>
                  <linearGradient id="Dégradé_sans_nom_2-5" x1="19.89" y1="76.27" x2="141.37" y2="193.45" href="#Dégradé_sans_nom_2"></linearGradient>
                  <linearGradient id="Dégradé_sans_nom_3-4" x1="38.58" y1="178.83" x2="83.36" y2="134.66" href="#Dégradé_sans_nom_3"></linearGradient>
                  ...
                  <linearGradient id="Dégradé_sans_nom_2-6" x1="147.41" y1="4.1" x2="181.15" y2="164.83" href="#Dégradé_sans_nom_2"></linearGradient>
                  <linearGradient id="Dégradé_sans_nom_3-5" x1="98.37" y1="94.42" x2="168.31" y2="80.31" href="#Dégradé_sans_nom_3"></linearGradient>
                </defs>
            ...
            <div className="about-description">
              <p>At Savor Naturals we provide all the necessary grocery items which are unadulterated, natural and 100% pure, which are produced by natural farming (jaivik kheti) and provided without contamination or mixing. Products are of excellent quality, fresh, chemical free, without pesticides and preservatives.</p>
            </div>
          </div>
          <div className="about-content-section2">
            <p className='my-3'><strong>“Health is Wealth”</strong> and <strong>“You are what you eat”</strong> are the main slogans we are working over. Our inspirations are Late Shree Rajiv Dixit ji and Millets man of India Dr. Khadar valiji.</p>
            <p className='my-4 slogan-about'>
              “When food is wrong, medicine is of no use,<br />
              When food is right, medicine is of no need”
              <br />
              <span className='name-about'>Dr. Khadar Vali</span>
            </p>
            <p className='my-4'>The slogan practically has been experienced at our home. In our family just by changing kitchen food items, we cured diseases like thyroid, PCOD, Nervous problem, allergy, diabetics. Improvement in our health was proof that all the medicines of all our diseases are in our kitchen and from last 3-4 years our family is medicine free.</p>
            <p className='my-4'>This is what we want for everyone now. We want everyone to live a healthy life and that can be achieved just by making small changes in kitchen. </p>
          </div>
        </div>
      </div>
      {/* <div className='continer ' style={{ marginBottom: "100px" }}>
      ...
      <div className='container row' style={{ paddingTop: "20px" }}>
        ...
        <div className='col' style={{ paddingLeft: "30px", marginTop: "200px" }}>
          <h3>At Savor Naturals we provide all the necessary grocery items which are unadulterated, natural and 100% pure, which are produced by natural farming (jaivik kheti) and provided without contamination or mixing. Products are of excellent quality, fresh, chemical free, without pesticides and preservatives. </h3>
        </div>
      </div>
      <div className='container' style={{ display: 'flex' }}>
        <div >
          <h3 style={{}}>“Health is Wealth” and “You are what you eat” are the main slogans we are working over. Our inspirations are Late Shree Rajiv Dixit ji and Millets man of India Dr. Khadar valiji.</h3>
        </div>
      </div>
      <div className='container my-2' style={{ display: 'flex' }}>
        <div class="alert alert-success" role="alert">
          <h2 style={{ textAlign: 'center' }}>“When food is wrong, medicine is of no use,When food is right, medicine is of no need”</h2>
          <h4 style={{ textAlign: 'right' }}>Dr. Khadar Vali</h4>
        </div>
      </div>
      <div className='container' style={{ display: 'flex' }}>
        <div >
          <h3 >
            Theslogan practically has been experienced at our home. In our family just by changing kitchen food items, we cured diseases like thyroid, PCOD, Nervous problem, allergy, diabetics. Improvement in our health was proof that all the medicines of all our diseases are in our kitchen and from last 3-4 years our family is medicine free.
          </h3>
          <h3>This is what we want for everyone now. We want everyone to live a healthy life and that can be achieved just by making small changes in kitchen. </h3>
        </div>
      </div>
    </div> */}
    </>
